...
**Vercel Postgres** — zero config. `DATABASE_URL` is set automatically when you add a Postgres store.

**Neon** — works out of the box. Use the pooled connection string from your Neon dashboard.
